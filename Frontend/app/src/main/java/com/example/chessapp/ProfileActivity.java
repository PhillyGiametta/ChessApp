...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void createProfile() {
        ...
        UserRequest newUser = new UserRequest(username, email);
        ...
        apiService.createProfile(newUser).enqueue(new Callback<UserResponse>() {
            ...
            public void onResponse(Call<UserResponse> call, Response<UserResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(ProfileActivity.this, "Profile creation failed", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void updateProfile() {
        ...
        // Pass the username as the path parameter to update
    ...
    private void deleteProfile() {
        ...
        // Pass the username as the path parameter to delete
            ...
            public void onResponse(Call<List<UserResponse>> call, Response<List<UserResponse>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (UserResponse profile : profiles) {
                        System.out.println("User: " + profile.getUsername() + ", Email: " + profile.getEmail());
                    }
                } else {
